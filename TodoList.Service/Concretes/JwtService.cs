...
public sealed class JwtService : IJwtService
{
    ...
    {
        DateTime accesTokenExpiration = DateTime.Now.AddMinutes(_tokenOption.AccessTokenExpiration);
        SecurityKey? secretkey = SecurityKeyHelper.GetSecurityKey(_tokenOption.SecurityKey);

        SigningCredentials signingCredentials = new SigningCredentials(secretkey, SecurityAlgorithms.HmacSha512Signature);
